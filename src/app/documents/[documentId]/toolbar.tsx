...
return (
  <DropdownMenu>
    <DropdownMenuTrigger asChild>
      <button
        className="h-7 w-[120px] flex items-center justify-between rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm"
        >
...
interface ToolbarButtonProps {
  onClick?: () => void; // Fixed: was 'onclick' (lowercase)
  isActive?: boolean;
  icon: LucideIcon;
    ...
    [
      {
        ...
        isActive: false, // Add explicit state if needed
      },
      {
        label: "Redo",
        icon: Redo2Icon,
    ...
    [
      {
        ...
        onClick: () => {
          console.log("TODO: Comment functionality");
